...
(19, 'Theme & Language', 'themelang', 'left', '', 1, 2);
...
(3, 'VIP', 'yes', 'no', 'no', 'yes', 'no', 'no', 'yes', 'no', 'no', 'yes', 'yes', 'yes', 'no', 'no', 'no'),
...
(1, 2, '2007-07-05 09:29:22', 'Welcome', 'Welcome To TorrentTrader v2');
...
CREATE TABLE `torrents` (
  ...
  `external` char(3) NOT NULL default 'no',
