...
if($editid > 0) {
	...
	echo("<tr><td>Team Name: </td><td align='right'><input type='text' size=50 name='team_name' value='$name'></td></tr>");
	echo("<tr><td>Team Logo URL: </td><td align='right'><input type='text' size=50 name='team_image' value='$image'></td></tr>");
	echo("<tr><td>Owner Name: </td><td align='right'><input type='text' size=50 name='team_owner' value='$owner'></td></tr>");
	echo("<tr><td valign=top>Description: </td><td align='right'><textarea name=team_info cols=35 rows=5>$info</textarea><BR>(BBCode is allowed)</td></tr>");
...
if($editmembers > 0) {
	...
	echo("<td class=table_head>Username</td><td class=table_head>Uploaded</td><td class=table_head>Downloaded</td></tr>");
...
echo("<form name='smolf3d' method='get' action='teams-create.php'>");
echo("<CENTER><table cellspacing=0 cellpadding=5 width=50%>");
echo("<tr><td>Team: </td><td align='left'><input type='text' size=50 name='team_name'></td></tr>");
echo("<tr><td>Owner Name: </td><td align='left'><input type='text' size=50 name='team_owner'></td></tr>");
echo("<tr><td valign=top>Description: </td><td align='left'><textarea name=team_description cols=35 rows=5></textarea><BR>(BBCode is allowed)</td></tr>");
echo("<tr><td>Teams Logo URL: </td><td align='left'><input type='text' size=50 name='team_image'><input type='hidden' name='add' value='true'></td></tr>");
echo("<tr><td></td><td><div align='left'><input value='Create Team' type='Submit'></div></td></tr>");
echo("</table></CENTER>");
if($success == TRUE) {
...
//ELSE Display Teams
print("<b>Current Teams:</b>");
print("<br>");
print("<br>");
echo("<CENTER><table class=table_table cellspacing=0 cellpadding=3>");
echo("<td class=table_head>ID</td><td class=table_head>Logo</td><td class=table_head>Name</td><td class=table_head>Owner</td><td class=table_head>Description</td><td class=table_head>Other</td>");
